...
router.get('/project/:projectId/metrics-history', authorizeRoles('hr', 'manager', 'team_leader', 'developer', 'admin', 'stakeholder'), getMetricsHistory);
...
router.get('/my-performance', getDeveloperPerformance);
